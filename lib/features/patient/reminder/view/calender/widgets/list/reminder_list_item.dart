...
import 'package:multi_vendor_medicene_pharmacy_deleivery_app/features/patient/reminder/view/calender/widgets/components/reminder_badge_group.dart';
...
class ReminderListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Dismissible(
         key: ValueKey('${item.medicine.id}-${item.time}-${item.days.join(",")}'),
      ...
      onDismissed: (_) {
        context.read<ReminderCubit>().deleteSingleReminder(
          item,
