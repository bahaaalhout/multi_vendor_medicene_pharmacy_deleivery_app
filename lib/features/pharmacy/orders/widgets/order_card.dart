...
import 'package:multi_vendor_medicene_pharmacy_deleivery_app/features/pharmacy/orders/screens/pharmacy_order_details_screen.dart';
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PharmacyOrderDetailsScreen(order: order),
          ),
        );
      },
      child: Container(
