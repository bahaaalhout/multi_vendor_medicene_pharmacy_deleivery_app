...
class Initial<T> implements AsyncState<T> {
  const Initial();
...
class Loading<T> implements AsyncState<T> {
  const Loading();
...
class Success<T> implements AsyncState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AsyncStateCopyWith<T, $Res> {
...
class Error<T> implements AsyncState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $AsyncStateCopyWith<T, $Res> {
